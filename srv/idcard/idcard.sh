...
echo -e "Ram : $(bc <<< "scale=2; $(cat /proc/meminfo | grep MemAvailable | awk '{ print $2 }') / 1024 / 1024")Go RAM restante sur $(bc <<< "scale=2; $(cat /proc/meminfo | grep MemTotal | awk '{ print $2 }') / 1024 / 1024")Go RAM totale \n"
